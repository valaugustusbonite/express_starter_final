...
var NAMESPACE = 'DB CONNECT';
var connectToMongo = function () { return __awaiter(void 0, void 0, void 0, function () {
    var dbUri, isConnected, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                dbUri = config_1.default.server.db_uri;
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
            ...
            case 2:
                isConnected = _a.sent();
                if (isConnected) {
                    logger_1.default.info(NAMESPACE, 'Connected to Mongo');
                }
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
                logger_1.default.error('db error', error_1);
                process.exit(1);
                return [3 /*break*/, 4];
